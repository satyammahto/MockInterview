  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: "#080B14" }}>
      <div className="w-full max-w-md px-8 py-10 rounded-2xl" style={{ background: "#0E1220", border: "1px solid #1E2535" }}>
        <div className="mb-8">
          <h1 className="font-heading text-3xl font-extrabold mb-1" style={{ color: "#E8EDF5" }}>Welcome back</h1>
          <p style={{ color: "#8892A4", fontSize: 14 }}>Sign in to continue your interview prep</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <p className="text-center text-sm" style={{ color: "#8892A4" }}>
            ...
            <Link href="/signup" className="font-semibold" style={{ color: "#4EFFA3" }}>Sign up</Link>
          </p>
        </form>
      </div>
    </div>
